...
import com.example.firstaidapp.ui.home.GuideCategories
import com.example.firstaidapp.utils.DataInitializer
import kotlinx.coroutines.launch

class AllGuidesViewModel(application: Application) : AndroidViewModel(application) {
    ...
    init {
        viewModelScope.launch {
            ...
            Log.d("AllGuidesViewModel", "Starting data initialization")
            DataInitializer.initializeData(getApplication())

            repository.allGuides.observeForever { guides ->
                Log.d("AllGuidesViewModel", "Total guides available: ${guides.size}")
